...
# data_arg.add_argument('--max_vocab_cnt', type=int, default=4000, help="if num of vocab is exceeded, then filter by freq")
        ...
        data_arg.add_argument('--corpus_target', type=str, default="")  ## given by path if it is empty
        ...
        # net_arg.add_argument('--path_pretrained_emb', type=str, default='embeddings/glove.6B.50d.txt')  # path or "bert-base-uncased"
        ...
        net_arg.add_argument('--target_model', type=str, default="cent_stru", 
                help='emnlp18, conll17, latent_doc_stru. dis_avg, dis_tt, cent_stru')
        ...
        misc_arg.add_argument('--ckpt_step', type=int, default=64)
        ...
        specific_arg.add_argument('--topk_fwr', type=int, default=7)  # used in cent_attn
