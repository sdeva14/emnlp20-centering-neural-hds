...
def process_config():
        ...
        data_arg.add_argument('--tokenizer_type', type=str, default='word', help="types of tokenizer")
        net_arg.add_argument('--path_pretrained_emb', type=str, default='embeddings/glove.6B.100d.txt')  # path or "bert-base-uncased"
